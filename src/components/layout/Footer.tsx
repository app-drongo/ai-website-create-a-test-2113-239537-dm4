          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Pioneering next-generation cloud infrastructure solutions for enterprise-scale
                applications. Trusted by Fortune 500 companies and innovative startups worldwide for
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">
                  2500 Innovation Drive, Tech Hub District
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive platform updates, security alerts, and technical insights. Enterprise-grade
                privacy guaranteed.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Engineered with <Heart className="size-3 text-red-500 fill-current" /> by our
                platform team
              </span>
            </div>
